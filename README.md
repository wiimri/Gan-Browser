...
```powershell
.\scripts\Publish-Release.ps1 -Version 2.5
```
...
```powershell
.\scripts\Verify-Release.ps1 -Version 2.5 -RequireAssets
```
...
Gan Browser `2.5` conserva temporalmente varios identificadores internos de GX Light Browser para que la actualizacion no pierda datos:
