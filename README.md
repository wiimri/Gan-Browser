...
- Modo de compatibilidad YouTube que pausa Gan Guard en videos para evitar bloqueos del reproductor.
...
```powershell
.\scripts\Publish-Release.ps1 -Version 2.16
```
...
```powershell
.\scripts\Verify-Release.ps1 -Version 2.16 -RequireAssets
```
...
Gan Browser `2.16` conserva temporalmente varios identificadores internos de GX Light Browser para que la actualizacion no pierda datos:
